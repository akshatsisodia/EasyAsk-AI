...
export default function SearchInput({collapsed}) {
    ...
    <div className="w-full px-5">
      <div className="w-full rounded-2xl bg-[#1a1a1a] border border-[#2a2a2a] px-4 py-3 gap-4 grow flex flex-col">
        ...
        <div className="flex items-center justify-between mt-3">
          <div className="shrink-0 w-8 h-8 rounded-full bg-[#0b0b0b] border border-[#2a2a2a] flex items-center justify-center text-gray-300 cursor-pointer">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M12 5v14M5 12h14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>

          <button className="ml-2 w-8 h-8 rounded-full bg-[#151515] border border-[#2a2a2a] flex items-center justify-center hover:bg-[#0F589D] cursor-pointer transition-colors" aria-label="submit">
